...
namespace FormulatrixUnitTest{
    public class UnitTest1{
        ...
        [InlineData("item2", "<to>Budhi</to><title>Test OOP Formulatrix</title><body>OOP Test Formulatrix</body>", 2)]
        ...
        public void ReturnFalse_GivenDuplicatedItemNameAndItemType_RegisteringJSON(){
            ...
            try{
                ...
                formulatrix.Register("item1", "{\"to\":\"budhi.afrianto8@gmail.com\",\"title\":\"Duplicated\",\"body\":\"Technical Test Formulatrix\"}", 1);
                formulatrix.Register("item1", "{\"to\":\"budhi.afrianto8@gmail.com\",\"title\":\"Duplicated\",\"body\":\"Hi there i am duplicated!\"}", 1);
        ...
        public void ReturnFalse_GivenDuplicatedItemNameAndItemType_RegisteringXML(){
            ...
            try{
                // Duplicating itemType and itemName
                formulatrix.Register("item2", "<to>Budhi</to><title>Test OOP Formulatrix</title><body>OOP Test Formulatrix</body>", 2);
                formulatrix.Register("item2", "<to>Budhi</to><title>Test OOP Formulatrix</title><body>OOP Test Formulatrix</body>", 2);
        ...
        public void ReturnFalse_GivenNoInputParameters_Registering(){
            ...
            try{
                // Duplicating itemType and itemName
                formulatrix.Register("", "{\"to\":\"budhi.afrianto8@gmail.com\",\"title\":\"Duplicated\",\"body\":\"OOP Test Formulatrix\"}", 1);
        ...
        public void Return1_GivenitemName_getType(){
            formulatrix.Register("item1", "{\"to\":\"budhi.afrianto8@gmail.com\",\"title\":\"Duplicated\",\"body\":\"OOP Test Formulatrix\"}", 1);
        ...
        public void ReturnStringXML_GivenitemName_Retrieve(){
            formulatrix.Register("item2", "<to>Budhi</to><title>Test OOP Formulatrix</title><body>OOP Test Formulatrix</body>", 2);
            Assert.Equal("<root><to>Budhi</to><title>Test OOP Formulatrix</title><body>OOP Test Formulatrix</body></root>", formulatrix.Retrieve("item2"));

        }

        [Fact]
        public void ReturnStringJson_GivenitemName_Retrieve(){
            formulatrix.Register("item1", "{\"to\":\"budhi.afrianto8@gmail.com\",\"title\":\"Hi there\",\"body\":\"OOP Test Formulatrix\"}", 1);
            Assert.Equal("{\"to\":\"budhi.afrianto8@gmail.com\",\"title\":\"Hi there\",\"body\":\"OOP Test Formulatrix\"}", formulatrix.Retrieve("item1"));
